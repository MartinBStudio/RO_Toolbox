...
public class BuffsManagerService {
    ...
    public void downloadAndExtract(String repoUrl, Path destDir) throws IOException {
        String effectiveRepoUrl = (repoUrl == null || repoUrl.isEmpty()) ? DEFAULT_REPO : repoUrl;
    ...
    private String buildZipUrl(String repoUrl, String branch) {
        String sanitized = repoUrl == null ? DEFAULT_REPO : repoUrl;
        ...
        return sanitized + "/archive/refs/heads/" + branch + ".zip";
    }

    private InputStream openUrlStream(String urlStr) throws IOException {
        URL url = new URL(urlStr);
        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
        conn.setRequestProperty("User-Agent", "RO_BuffsManager/1.0");
