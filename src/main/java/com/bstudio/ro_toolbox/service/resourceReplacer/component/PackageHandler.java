...
public class PackageHandler implements ICommonResourceMethods {
  ...
  public List<Resource> listAvailablePackages(
  ...
  public void manageInstalledPackage(
      String profileId,
  ...
  public void uninstallPackageFiles(Path installedDir, Path resourcesDir, String manifestFileName)
      throws IOException {
